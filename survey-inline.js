...
const steps=[{id:'profile',label:'ข้อมูลทั่วไป'},{id:'confidence',label:'ความมั่นใจ'},{id:'knowledge',label:'แบบทดสอบ'},{id:'review',label:'สรุปผล'}];
let current=0;
...
function renderStep(id){if(id==='profile')return renderProfile();if(id==='confidence')return renderScaleSection('confidence','ความมั่นใจในการเรียนและการฝึกปฏิบัติ',surveyData.confidenceItems);if(id==='knowledge')return renderKnowledge();return renderReview();}
